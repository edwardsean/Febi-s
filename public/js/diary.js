...
// draft = document.querySelector(".draftBox");
...
//select drafts
    ...
    //     // } 
    //     editOrpostButton.style.display = "flex";
    //     selectionMode = !selectionMode;
    //     draft.forEach((draftBox) => {
    //         const selectCircle = draftBox.querySelector(".selectCircle");
    //         selectCircle.style.display = selectionMode ? "block" : "none";
    //     });
